    ...
    describe("node auto-require", () => {
      it("works with the -r flag", async () => {
        ...
        expect(output.trim()).toMatchInlineSnapshot(`
          "It worked! function () {}
          (node:4791) [DEP0180] DeprecationWarning: fs.Stats constructor is deprecated.
      ...
      it("works with the --require flag", async () => {
        ...
        expect(output.trim()).toMatchInlineSnapshot(`
          "It worked! function () {}
          (node:4803) [DEP0180] DeprecationWarning: fs.Stats constructor is deprecated.
          (Use \`node --trace-deprecation ...\` to show where the warning was created)
          Browserslist: caniuse-lite is outdated. Please run:
            npx update-browserslist-db@latest
            Why you should do it regularly: https://github.com/browserslist/update-db#readme"
      ...
      it("works with the -r flag in NODE_OPTIONS", async () => {
        ...
        expect(output.trim()).toMatchInlineSnapshot(`
          "It worked! function () {}
          (node:4815) [DEP0180] DeprecationWarning: fs.Stats constructor is deprecated.
          (Use \`node --trace-deprecation ...\` to show where the warning was created)
          Browserslist: caniuse-lite is outdated. Please run:
            npx update-browserslist-db@latest
            Why you should do it regularly: https://github.com/browserslist/update-db#readme"
      ...
      it("works with the --require flag in NODE_OPTIONS", async () => {
        ...
        expect(output.trim()).toMatchInlineSnapshot(`
          "It worked! function () {}
          (node:4827) [DEP0180] DeprecationWarning: fs.Stats constructor is deprecated.
          (Use \`node --trace-deprecation ...\` to show where the warning was created)
          Browserslist: caniuse-lite is outdated. Please run:
            npx update-browserslist-db@latest
            Why you should do it regularly: https://github.com/browserslist/update-db#readme"
